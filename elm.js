...
Elm.Material.Aux = Elm.Material.Aux || {};
Elm.Material.Aux.make = function (_elm) {
   "use strict";
   _elm.Material = _elm.Material || {};
   _elm.Material.Aux = _elm.Material.Aux || {};
   if (_elm.Material.Aux.values) return _elm.Material.Aux.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var mapWithIndex = F2(function (f,xs) {
      var loop = F2(function (k,ys) {
         ...
         if (_p0.ctor === "[]") {
               ...
               return A2($List._op["::"],A2(f,k,_p0._0),A2(loop,k + 1,_p0._1));
            }
      });
      return A2(loop,0,xs);
   });
   var filter = F3(function (elem,attr,html) {    return A2(elem,attr,A2($List.filterMap,function (x) {    return x;},html));});
   return _elm.Material.Aux.values = {_op: _op,filter: filter,mapWithIndex: mapWithIndex,effect: effect,pure: pure,clip: clip,blurOn: blurOn};
};
Elm.Material = Elm.Material || {};
...
Elm.Material.Ripple.make = function (_elm) {
   ...
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Material$Aux = Elm.Material.Aux.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   ...
   var update = F2(function (action,model) {
      var _p7 = action;
      switch (_p7.ctor)
      {case "Down": return A2($Material$Aux.effect,
           $Effects.tick(function (_p8) {    return Tick;}),
           _U.update(model,{animation: Frame(0),metrics: computeMetrics(_p7._0)}));
         case "Up": return A2($Material$Aux.effect,$Effects.none,_U.update(model,{animation: Inert}));
         default: return A2($Material$Aux.effect,$Effects.none,_U.update(model,{animation: Frame(1)}));}
   });
...
Elm.Material.Button.make = function (_elm) {
   ...
   var view = F5(function (kind,addr,model,coloring,html) {
      return A2($Html.button,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "mdl-button",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "mdl-js-button",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "mdl-js-ripple-effect",_1: !_U.eq(model,S($Maybe.Nothing))}
                                                  ,{ctor: "_Tuple2",_0: "mdl-button--colored",_1: _U.eq(coloring,Colored)}
                                                  ,{ctor: "_Tuple2",_0: "mdl-button--primary",_1: _U.eq(coloring,Primary)}
                                                  ,{ctor: "_Tuple2",_0: "mdl-button--accent",_1: _U.eq(coloring,Accent)}
                                                  ,{ctor: "_Tuple2",_0: kind,_1: !_U.eq(kind,"")}]))
              ,$Material$Aux.blurOn("mouseup")
              ,$Material$Aux.blurOn("mouseleave")
      ...
      function () {
         ...
         if (_p3._0.ctor === "Just") {
               ...
               _U.list([$Html$Attributes.$class("mdl-button__ripple-container"),$Material$Aux.blurOn("mouseup")]),
               _p3._0._0),
               html);
            } else {
               return html;
...
Elm.Material.Grid.make = function (_elm) {
   ...
   var cell = F2(function (configs,elms) {
      return Cell(A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($String.join,
      " ",
      A2($List._op["::"],"mdl-cell",A2($List.map,function (_p1) {    var _p2 = _p1;return _p2._0;},configs))))]),
      elms));
   });
   var Config = function (a) {    return {ctor: "Config",_0: a};};
   var size = F2(function (device,k) {
      var c = function () {
         var _p3 = device;
         switch (_p3.ctor)
         {case "All": return A3($Material$Aux.clip,1,12,k);
            case "Desktop": return A3($Material$Aux.clip,1,12,k);
            case "Tablet": return A3($Material$Aux.clip,1,8,k);
            default: return A3($Material$Aux.clip,1,4,k);}
      }();
      return Config(A2($Basics._op["++"],"mdl-cell--",A2($Basics._op["++"],$Basics.toString(c),A2($Basics._op["++"],"-col",suffix(device)))));
   });
   var offset = F2(function (device,k) {
      var c = function () {
         var _p4 = device;
         switch (_p4.ctor)
         {case "All": return A3($Material$Aux.clip,1,11,k);
            case "Desktop": return A3($Material$Aux.clip,1,11,k);
            case "Tablet": return A3($Material$Aux.clip,1,7,k);
            default: return A3($Material$Aux.clip,1,3,k);}
      }();
      return Config(A2($Basics._op["++"],"mdl-cell--",A2($Basics._op["++"],$Basics.toString(c),A2($Basics._op["++"],"-offset",suffix(device)))));
   });
   var align = function (a) {
      return Config(function () {
         var _p5 = a;
         switch (_p5.ctor)
         {case "Top": return "mdl-cell--top";
            case "Middle": return "mdl-cell--middle";
            default: return "mdl-cell--bottom";}
      }());
   };
   ...
   var order = F2(function (device,n) {
      return Config(A2($Basics._op["++"],"mdl-cell--order-",A2($Basics._op["++"],$Basics.toString(A3($Material$Aux.clip,1,12,n)),suffix(device))));
   });
   var Phone = {ctor: "Phone"};
   var Tablet = {ctor: "Tablet"};
   var Desktop = {ctor: "Desktop"};
   var All = {ctor: "All"};
   var gridWithOptions = F2(function (options,elms) {
      return A2($Html.div,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "mdl-grid",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "mdl-grid--no-spacing",_1: $Basics.not(options.spacing)}]))
              ,$Html$Attributes.style(A2($Maybe.withDefault,
              _U.list([]),
              A2($Maybe.map,function (maxwidth) {    return _U.list([{ctor: "_Tuple2",_0: "max-width",_1: maxwidth}]);},options.maxWidth)))]),
      A2($List.map,function (_p7) {    var _p8 = _p7;return _p8._0;},elms));
   });
   var defaultOptions = {spacing: true,maxWidth: $Maybe.Nothing};
   var grid = gridWithOptions(defaultOptions);
   var Options = F2(function (a,b) {    return {spacing: a,maxWidth: b};});
   return _elm.Material.Grid.values = {_op: _op
                                      ,grid: grid
                                      ,gridWithOptions: gridWithOptions
                                      ,cell: cell
                                      ,size: size
                                      ,offset: offset
                                      ,align: align
...
Elm.Demo.Buttons.make = function (_elm) {
   ...
   var describe = F3(function (kind,ripple,coloring) {
      var c = function () {
         var _p4 = coloring;
         switch (_p4.ctor)
   ...
   var tabulate$ = F2(function (i,ys) {
      var _p5 = ys;
      if (_p5.ctor === "[]") {
            return _U.list([]);
         } else {
            return A2($List._op["::"],{ctor: "_Tuple2",_0: i,_1: _p5._0},A2(tabulate$,i + 1,_p5._1));
         }
   });
   var tabulate = tabulate$(0);
   var row = F2(function (_p6,ripple) {
      var _p7 = _p6;
      return tabulate(A2($List.map,
      function (c) {
         return {ctor: "_Tuple3",_0: ripple,_1: A3(describe,_p7._0,ripple,c),_2: A3(view$,_p7._2,c,_p7._1)};
      },
      _U.list([$Material$Button.Plain,$Material$Button.Colored,$Material$Button.Primary,$Material$Button.Accent])));
   });
   var buttons = A2($List.map,
   function (_p8) {
      var _p9 = _p8;
      return A2($List.map,function (_p10) {    var _p11 = _p10;return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p9._0,_1: _p11._0},_1: _p11._1};},_p9._1);
   },
   tabulate(A2($List.concatMap,
   function (a) {
   ...
   var model = {clicked: ""
               ...
               $List.map(function (_p12) {    var _p13 = _p12;return {ctor: "_Tuple2",_0: _p13._0,_1: $Material$Button.model(_p13._1._0)};}),
               buttons))};
   var view = F2(function (addr,model) {
      return $Material$Grid.grid(A2($List.concatMap,
      function (row) {
         return A2($List.concatMap,
         function (_p14) {
            var _p15 = _p14;
            var _p16 = _p15._0;
            var model$ = A2($Maybe.withDefault,$Material$Button.model(false),A2($Dict.get,_p16,model.buttons));
...
Elm.Demo.Grid.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = _U.list([$Material$Grid.grid(A2($List.map,
                      function (i) {
                         return A2($Material$Grid.cell,_U.list([A2($Material$Grid.size,$Material$Grid.All,1)]),_U.list([$Html.text("1")]));
                      },
                      _U.range(1,12)))
                      ,$Material$Grid.grid(A2($List.map,
                      function (i) {
                         return A2($Material$Grid.cell,_U.list([A2($Material$Grid.size,$Material$Grid.All,4)]),_U.list([$Html.text("4")]));
                      },
                      _U.range(1,3)))
                      ,$Material$Grid.grid(_U.list([A2($Material$Grid.cell,_U.list([A2($Material$Grid.size,$Material$Grid.All,6)]),_U.list([$Html.text("6")]))
                                                   ,A2($Material$Grid.cell,_U.list([A2($Material$Grid.size,$Material$Grid.All,4)]),_U.list([$Html.text("4")]))
                                                   ,A2($Material$Grid.cell,
                                                   _U.list([A2($Material$Grid.size,$Material$Grid.All,2)]),
                                                   _U.list([$Html.text("2")]))]))
                      ,$Material$Grid.grid(_U.list([A2($Material$Grid.cell,
   ...
   return _elm.Demo.Grid.values = {_op: _op,view: view};
};
Elm.Material = Elm.Material || {};
...
Elm.Demo.Textfields.make = function (_elm) {
   ...
   var view = F2(function (addr,model) {
      return $Material$Grid.grid(A2($List.map,
      function (x) {
...
Elm.Material.Layout.make = function (_elm) {
   ...
   var view = F3(function (addr,model,_p3) {
      ...
      _U.list([A3($Material$Aux.filter,
      $Html.div,
   ...
   var update = F2(function (action,model) {
      ...
      {case "SmallScreen": var _p14 = _p13._0;
           return $Material$Aux.pure(_U.update(model,{state: S(_U.update(state,{isSmallScreen: _p14})),isDrawerOpen: $Basics.not(_p14) && model.isDrawerOpen}));
         case "SwitchTab": return $Material$Aux.pure(_U.update(model,{selectedTab: _p13._0}));
         case "ToggleDrawer": return $Material$Aux.pure(_U.update(model,{isDrawerOpen: $Basics.not(model.isDrawerOpen)}));
         case "Ripple": var _p18 = _p13._0;
           var _p15 = A2($Maybe.withDefault,
           $Material$Aux.pure(state),
           A2($Maybe.map,
           function (_p16) {
              var _p17 = _p16;
...
Elm.Material.make = function (_elm) {
   ...
   var css = F2(function (primary,accent) {
      var cssFile = function () {
         ...
         {case "Grey": return "";
            ...
            default: return A2($Basics._op["++"],".",A2($Basics._op["++"],toString(primary),A2($Basics._op["++"],"-",toString(accent))));}
      }();
      ...
      _U.list([A2($Basics._op["++"],"https://code.getmdl.io/1.1.1/material",A2($Basics._op["++"],cssFile,".min.css"))
   ...
   var topWithColors = F3(function (primary,accent,content) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A3($Html.node,"style",_U.list([$Html$Attributes.type$("text/css")]),_U.list([$Html.text(A2(css,primary,accent))])),content]));
   });
   ...
   var Grey = {ctor: "Grey"};
   var top = function (content) {    return A3(topWithColors,Grey,Grey,content);};
...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "LayoutAction": var _p2 = A2($Material$Layout.update,_p1._0,model.layout);
           var l = _p2._0;
           var e = _p2._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{layout: l}),_1: A2($Effects.map,LayoutAction,e)};
         case "ButtonsAction": var _p3 = A2($Demo$Buttons.update,_p1._0,model.buttons);
           var b = _p3._0;
           var e = _p3._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{buttons: b}),_1: A2($Effects.map,ButtonsAction,e)};
         default: return {ctor: "_Tuple2",_0: _U.update(model,{textfields: A2($Demo$Textfields.update,_p1._0,model.textfields)}),_1: $Effects.none};}
   });
   var view = F2(function (addr,model) {
      var top = A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "auto"},{ctor: "_Tuple2",_0: "width",_1: "90%"}]))]),
   ...
   var Model = F3(function (a,b,c) {    return {layout: a,buttons: b,textfields: c};});
