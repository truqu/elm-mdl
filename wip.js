...
Elm.Material.Snackbar.make = function (_elm) {
   ...
   var liftTransition = function (_p0) {    var _p1 = _p0;var _p2 = _p1._0;return {ctor: "_Tuple2",_0: _p2,_1: A2($Effects.map,Move(_p2.seq),_p1._1)};};
   var Action = function (a) {    return {ctor: "Action",_0: a};};
   var forwardClick = F2(function (transition,model) {
      var _p3 = {ctor: "_Tuple2",_0: transition,_1: model.state};
      if (_p3.ctor === "_Tuple2" && _p3._0.ctor === "Click" && _p3._1.ctor === "Active") {
            return A2($Maybe.withDefault,
            function (x) {
               return x;
            },
            A2($Maybe.map,function (_p4) {    return $Material$Helpers.addFx($Effects.task($Task.succeed(Action($Basics.snd(_p4)))));},_p3._1._0.action));
         } else {
            return function (x) {
               return x;
            };
   ...
   var delay = F2(function (t,x) {    return $Effects.task(A3($Basics.flip,$Task.andThen,function (_p5) {    return $Task.succeed(x);},$Task.sleep(t)));});
   var Click = {ctor: "Click"};
   ...
   var tryDequeue = function (model) {
      ...
      if (_p6.ctor === "_Tuple2" && _p6._0.ctor === "Inert" && _p6._1.ctor === "::") {
            var _p7 = _p6._1._0;
            return {ctor: "_Tuple2",_0: _U.update(model,{state: Active(_p7),queue: _p6._1._1,seq: model.seq + 1}),_1: A2(delay,_p7.timeout,Timeout)};
         } else {
            return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         }
   };
   ...
   var move = F2(function (transition,model) {
      var _p8 = {ctor: "_Tuple2",_0: model.state,_1: transition};
      _v3_3: do {
         if (_p8.ctor === "_Tuple2") {
               switch (_p8._0.ctor)
               {case "Inert": if (_p8._1.ctor === "Timeout") {
                          return tryDequeue(model);
                       } else {
                          break _v3_3;
                       }
                  case "Active": var _p9 = _p8._0._0;
                    return {ctor: "_Tuple2",_0: _U.update(model,{state: Fading(_p9)}),_1: A2(delay,_p9.fade,Timeout)};
                  default: if (_p8._1.ctor === "Timeout") {
                          return {ctor: "_Tuple2",_0: _U.update(model,{state: Inert}),_1: $Effects.tick(function (_p10) {    return Timeout;})};
                       } else {
                          break _v3_3;
                       }}
            } else {
   ...
   var update = F2(function (action,model) {
      var _p11 = action;
      switch (_p11.ctor)
      {case "Action": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Add": return liftTransition(tryDequeue(A2(enqueue,_p11._0,model)));
         default: var _p12 = _p11._1;
           return _U.eq(_p11._0,model.seq) ? A3(forwardClick,_p12,model,liftTransition(A2(move,_p12,model))) : {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var contentsOf = function (model) {
      var _p13 = model.state;
      switch (_p13.ctor)
      {case "Inert": return $Maybe.Nothing;
         case "Active": return $Maybe.Just(_p13._0);
         default: return $Maybe.Just(_p13._0);}
   };
   var view = F2(function (addr,model) {
      ...
      var _p15 = A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: _U.list([]),_1: _U.list([])},
      A2($Maybe.map,
      function (_p16) {
         var _p17 = _p16;
         return {ctor: "_Tuple2",_0: _U.list([$Html.text(_p17._0)]),_1: _U.list([A2($Html$Events.onClick,addr,A2(Move,model.seq,Click))])};
      },
      A3($Basics.flip,$Maybe.andThen,function (_) {    return _.action;},contentsOf(model))));
      var buttonBody = _p15._0;
      var buttonHandler = _p15._1;
      var textBody = A2($Maybe.withDefault,_U.list([]),A2($Maybe.map,function (c) {    return _U.list([$Html.text(c.message)]);},contentsOf(model)));
      var active = !_U.eq(model.queue,_U.list([]));
      return A2($Html.div,
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("mdl-snackbar__text")]),textBody)
              ,A2($Html.button,
              A2($List._op["::"],$Html$Attributes.$class("mdl-snackbar__action"),A2($List._op["::"],$Html$Attributes.type$("button"),buttonHandler)),
              buttonBody)]));
   });
   var isActive = function (model) {
   ...
   var snackbar = F3(function (message,actionMessage,action) {
      return {message: message,action: $Maybe.Just({ctor: "_Tuple2",_0: actionMessage,_1: action}),timeout: 2750,fade: 250};
   });
   var toast = function (message) {    return {message: message,action: $Maybe.Nothing,timeout: 2750,fade: 250};};
   var model = {queue: _U.list([]),state: Inert,seq: 0};
   var Model = F3(function (a,b,c) {    return {queue: a,state: b,seq: c};});
   var Contents = F4(function (a,b,c,d) {    return {message: a,action: b,timeout: c,fade: d};});
...
Elm.Material.make = function (_elm) {
   ...
   var scheme = F2(function (primary,accent) {
      ...
      _U.list([A2($Basics._op["++"],"https://code.getmdl.io/1.1.2/",A2($Material$Color.scheme,primary,accent))
   ...
   return _elm.Material.values = {_op: _op,topWithScheme: topWithScheme,top: top,lift: lift,lift$: lift$};
};
Elm.Demo = Elm.Demo || {};
...
Elm.Demo.Snackbar.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var intro = $Markdown.toHtml("\n# Snackbars & toasts\n\nFrom the\n[Material Design Lite documentation](https://www.getmdl.io/components/index.html#snackbar-section).\n\n> The Material Design Lite (MDL) __snackbar__ component is a container used to\n> notify a user of an operation\'s status. It displays at the bottom of the\n> screen. A snackbar may contain an action button to execute a command for the\n> user. Actions should undo the committed action or retry it if it failed for\n> example. Actions should not be to close the snackbar. By not providing an\n> action, the snackbar becomes a __toast__ component.\n\n#### See also\n\n - [Demo source code](https://github.com/debois/elm-mdl/blob/master/examples/Demo/Snackbar.elm)\n - [elm-mdl package documentation](http://package.elm-lang.org/packages/debois/elm-mdl/latest/Material-Snackbar)\n - [Material Design Specification](https://www.google.com/design/spec/components/snackbars-toasts.html)\n - [Material Design Lite documentation](https://www.getmdl.io/components/index.html#snackbar-section)\n\n#### Demo\n\n");
   var clickView = F2(function (model,k) {
      var selected = _U.eq(k,model.snackbar.seq - 1) && !_U.eq($Material$Snackbar.isActive(model.snackbar),$Maybe.Nothing);
      var color = A3($Basics.flip,
      $Material$Color.color,
      $Material$Color.S500,
      A2($Maybe.withDefault,$Material$Color.Teal,A2($Array.get,A2($Basics._op["%"],k + 4,$Array.length($Material$Color.palette)),$Material$Color.palette)));
      return A4($Material$Style.styled,
      $Html.div,
      _U.list([$Material$Color.background(color)
              ,$Material$Color.text($Material$Color.primaryContrast)
              ,$Material$Style.cs(A2($Basics._op["++"],"mdl-shadow--",selected ? "8dp" : "2dp"))]),
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-right",_1: "3ex"}
                                              ,{ctor: "_Tuple2",_0: "margin-bottom",_1: "3ex"}
                                              ,{ctor: "_Tuple2",_0: "padding",_1: "1.5ex"}
                                              ,{ctor: "_Tuple2",_0: "width",_1: "4ex"}
                                              ,{ctor: "_Tuple2",_0: "border-radius",_1: "2px"}
                                              ,{ctor: "_Tuple2",_0: "display",_1: "inline-block"}
                                              ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}
                                              ,{ctor: "_Tuple2",_0: "transition",_1: "box-shadow 333ms ease-in-out 0s"}]))
              ,$Html$Attributes.key($Basics.toString(k))]),
      _U.list([$Html.text($Basics.toString(k))]));
   });
   var toast = function (k) {    return $Material$Snackbar.toast(A2($Basics._op["++"],"Toast message #",$Basics.toString(k)));};
   var SnackbarButtonAction = function (a) {    return {ctor: "SnackbarButtonAction",_0: a};};
   var ToastButtonAction = function (a) {    return {ctor: "ToastButtonAction",_0: a};};
   var SnackbarAction = function (a) {    return {ctor: "SnackbarAction",_0: a};};
   var add = F2(function (f,model) {
      var _p0 = A2($Material$Snackbar.update,$Material$Snackbar.Add(f(model.count)),model.snackbar);
      var snackbar$ = _p0._0;
      var effects = _p0._1;
      return {ctor: "_Tuple2"
             ,_0: _U.update(model,{snackbar: snackbar$,count: model.count + 1,clicked: A2($List._op["::"],model.count,model.clicked)})
             ,_1: A2($Effects.map,SnackbarAction,effects)};
   });
   var view = F2(function (addr,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([intro
              ...
              _U.list([A2($Material$Grid.cell,
                      _U.list([A2($Material$Grid.size,$Material$Grid.All,2)
                              ,A2($Material$Grid.size,$Material$Grid.Phone,2)
                              ,$Material$Grid.align($Material$Grid.Top)]),
                      _U.list([A4($Material$Button.raised,
                      A2($Signal.forwardTo,addr,ToastButtonAction),
                      model.toastButton,
                      _U.list([]),
                      ...
                      _U.list([A2($Material$Grid.size,$Material$Grid.All,2)
                              ...
                              ,$Material$Grid.align($Material$Grid.Top)]),
                      _U.list([A4($Material$Button.raised,
                      A2($Signal.forwardTo,addr,SnackbarButtonAction),
                      model.snackbarButton,
                      _U.list([]),
                      _U.list([$Html.text("Snackbar")]))]))
                      ,A2($Material$Grid.cell,
                      _U.list([A2($Material$Grid.size,$Material$Grid.Desktop,7)
                              ,A2($Material$Grid.size,$Material$Grid.Tablet,3)
                              ,A2($Material$Grid.size,$Material$Grid.Phone,12)
                              ,$Material$Grid.align($Material$Grid.Top)]),
                      A2($List.map,clickView(model),$List.reverse(model.clicked)))]))
              ,A2($Material$Snackbar.view,A2($Signal.forwardTo,addr,SnackbarAction),model.snackbar)]));
   });
   var Undo = function (a) {    return {ctor: "Undo",_0: a};};
   var snackbar = function (k) {    return A3($Material$Snackbar.snackbar,A2($Basics._op["++"],"Snackbar message #",$Basics.toString(k)),"UNDO",Undo(k));};
   var update = F2(function (action,model) {
      update: while (true) {
         var _p1 = action;
         switch (_p1.ctor)
         {case "Undo": return {ctor: "_Tuple2"
                              ,_0: _U.update(model,{clicked: A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})(_p1._0),model.clicked)})
                              ,_1: $Effects.none};
            case "SnackbarAction": if (_p1._0.ctor === "Action") {
                    var _v1 = _p1._0._0,_v2 = model;
                    action = _v1;
                    model = _v2;
                    continue update;
                 } else {
                    return A6($Material.lift,
                    function (_) {
                       return _.snackbar;
                    },
                    F2(function (m,x) {    return _U.update(m,{snackbar: x});}),
                    SnackbarAction,
                    $Material$Snackbar.update,
                    _p1._0,
                    model);
                 }
            case "ToastButtonAction": if (_p1._0.ctor === "Click") {
                    return A2(add,toast,model);
                 } else {
                    return A6($Material.lift,
                    function (_) {
                       return _.toastButton;
                    },
                    F2(function (m,x) {    return _U.update(m,{toastButton: x});}),
                    ToastButtonAction,
                    $Material$Button.update,
                    _p1._0,
                    model);
                 }
            default: if (_p1._0.ctor === "Click") {
                    return A2(add,snackbar,model);
                 } else {
                    return A6($Material.lift,
                    function (_) {
                       return _.snackbarButton;
                    },
                    F2(function (m,x) {    return _U.update(m,{snackbarButton: x});}),
   ...
   var model = {count: 0
               ...
               ,toastButton: $Material$Button.model(true)
               ,snackbarButton: $Material$Button.model(true)};
   var Model = F5(function (a,b,c,d,e) {    return {count: a,clicked: b,snackbar: c,toastButton: d,snackbarButton: e};});
   return _elm.Demo.Snackbar.values = {_op: _op
                                      ,Model: Model
                                      ,model: model
                                      ,Undo: Undo
                                      ,SnackbarAction: SnackbarAction
                                      ,ToastButtonAction: ToastButtonAction
                                      ,SnackbarButtonAction: SnackbarButtonAction
                                      ,snackbar: snackbar
                                      ,toast: toast
                                      ,add: add
                                      ,update: update
...
Elm.Material.Textfield.make = function (_elm) {
   ...
   var view = F2(function (addr,model) {
      ...
      _U.list([$Maybe.Just(A2($Html.input,
              ...
              ,A2($Maybe.map,
              function (l) {
                 return A2($Html.label,_U.list([$Html$Attributes.$class("mdl-textfield__label")]),_U.list([$Html.text(l.text)]));
              },
              model.label)
              ,A2($Maybe.map,
              function (e) {
...
Elm.Demo.Textfields.make = function (_elm) {
   ...
   if (_elm.Demo.Textfields.values) return _elm.Demo.Textfields.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (_p0,fields) {
      var _p1 = _p0;
      var _p2 = _p1._0;
      return A2($Maybe.withDefault,
      fields,
      A2($Maybe.map,
      function (field$) {
         return A3($Array.set,_p2,field$,fields);
      },
      A2($Maybe.map,$Material$Textfield.update(_p1._1),A2($Array.get,_p2,fields))));
   });
   var Field = F2(function (a,b) {    return {ctor: "Field",_0: a,_1: b};});
   var view = F2(function (addr,model) {
      return A2($Material$Grid.grid,
      _U.list([]),
      A2($List.map,
      function (x) {
         return A2($Material$Grid.cell,_U.list([A2($Material$Grid.size,$Material$Grid.All,3)]),_U.list([x]));
      },
      $Array.toList(A2($Array.indexedMap,F2(function (k,field) {    return A2($Material$Textfield.view,A2($Signal.forwardTo,addr,Field(k)),field);}),model))));
   });
   var model = function () {
      var t0 = $Material$Textfield.model;
      return $Array.fromList(_U.list([t0
                                     ,_U.update(t0,{label: $Maybe.Just({text: "Labelled",$float: false})})
                                     ,_U.update(t0,{label: $Maybe.Just({text: "Floating label",$float: true})})
                                     ,_U.update(t0,{label: $Maybe.Just({text: "Disabled",$float: false}),isDisabled: true})
                                     ,_U.update(t0,
                                     {label: $Maybe.Just({text: "With error and value",$float: false})
                                     ,error: $Maybe.Just("The input is wrong!")
                                     ,value: "Incorrect input"})]));
   }();
   return _elm.Demo.Textfields.values = {_op: _op,model: model,Field: Field,update: update,view: view};
};
...
Elm.Material.Layout.make = function (_elm) {
   ...
   var headerView = F2(function (model,_p0) {
      var _p1 = _p0;
      return A3($Material$Helpers.filter,
      $Html.header,
      ...
      _U.list([_p1._0,A2($Maybe.map,$Html.div(_U.list([$Html$Attributes.$class("mdl-layout__header-row")])),_p1._1),_p1._2]));
   });
   ...
   var view = F3(function (addr,model,_p3) {
      var _p4 = _p3;
      var _p11 = _p4.tabs;
      var _p10 = _p4.header;
      var _p9 = _p4.drawer;
      var hasHeader = !_U.eq(_p11,$Maybe.Nothing) || !_U.eq(_p10,$Maybe.Nothing);
      var mode = function () {
         var _p5 = model.mode;
         switch (_p5.ctor)
      ...
      var _p6 = function () {
         var _p7 = {ctor: "_Tuple3",_0: _p9,_1: _p10,_2: model.fixedHeader};
         if (_p7.ctor === "_Tuple3" && _p7._0.ctor === "Just") {
               if (_p7._1.ctor === "Just" && _p7._2 === true) {
      ...
      var contentDrawerButton = _p6._0;
      var headerDrawerButton = _p6._1;
      return A2($Html.div,
      ...
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "mdl-layout",_1: true}
                                                  ...
                                                  ,{ctor: "_Tuple2",_0: "has-drawer",_1: !_U.eq(_p9,$Maybe.Nothing)}
                                                  ,{ctor: "_Tuple2",_0: "has-tabs",_1: !_U.eq(_p11,$Maybe.Nothing)}
                                                  ,{ctor: "_Tuple2",_0: "mdl-js-layout",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "mdl-layout--fixed-drawer",_1: model.fixedDrawer && !_U.eq(_p9,$Maybe.Nothing)}
                                                  ,{ctor: "_Tuple2",_0: "mdl-layout--fixed-header",_1: model.fixedHeader && hasHeader}
                                                  ,{ctor: "_Tuple2",_0: "mdl-layout--fixed-tabs",_1: model.fixedTabs && !_U.eq(_p11,$Maybe.Nothing)}]))]),
      _U.list([hasHeader ? $Maybe.Just(A2(headerView,
              model,
              {ctor: "_Tuple3",_0: headerDrawerButton,_1: _p10,_2: A2($Maybe.map,A2(tabsView,addr,model),_p11)})) : $Maybe.Nothing
              ,A2($Maybe.map,function (_p8) {    return A2(obfuscator,addr,model);},_p9)
              ,A2($Maybe.map,A2(drawerView,addr,model),_p9)
              ,contentDrawerButton
              ,$Maybe.Just(A2($Html.main$,_U.list([$Html$Attributes.$class("mdl-layout__content")]),_p4.main))]))]));
   });
   var S = function (a) {    return {ctor: "S",_0: a};};
   var initState = function (no_tabs) {    return S({tabs: A2($Array.repeat,no_tabs,$Material$Ripple.model),isSmallScreen: false});};
   ...
   var update = F2(function (action,model) {
      ...
      var _p13 = action;
      switch (_p13.ctor)
      {case "SmallScreen": var _p14 = _p13._0;
           return $Material$Helpers.pure(_U.update(model,
           {state: S(_U.update(state,{isSmallScreen: _p14})),isDrawerOpen: $Basics.not(_p14) && model.isDrawerOpen}));
         case "SwitchTab": return $Material$Helpers.pure(_U.update(model,{selectedTab: _p13._0}));
         case "ToggleDrawer": return $Material$Helpers.pure(_U.update(model,{isDrawerOpen: $Basics.not(model.isDrawerOpen)}));
         case "Ripple": var _p18 = _p13._0;
           var _p15 = A2($Maybe.withDefault,
           $Material$Helpers.pure(state),
           A2($Maybe.map,
           function (_p16) {
              var _p17 = _p16;
              return {ctor: "_Tuple2",_0: _U.update(state,{tabs: A3($Array.set,_p18,_p17._0,s(model).tabs)}),_1: A2($Effects.map,Ripple(_p18),_p17._1)};
           },
           A2($Maybe.map,$Material$Ripple.update(_p13._1),A2($Array.get,_p18,s(model).tabs))));
           var state$ = _p15._0;
           var effect = _p15._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{state: S(state$)}),_1: effect};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var State$ = F2(function (a,b) {    return {tabs: a,isSmallScreen: b};});
   var setupSizeChangeSignal = function (f) {
      return A2($Signal.map,
      function (_p19) {
         return f(SmallScreen(_p19));
      },
...
Elm.Main.make = function (_elm) {
   ...
   var header = _U.list([$Material$Layout.title("elm-mdl")
                        ,$Material$Layout.spacer
                        ,$Material$Layout.navigation(_U.list([A2($Material$Layout.link,
                                                             _U.list([$Html$Attributes.href("https://www.getmdl.io/components/index.html")]),
                                                             _U.list([$Html.text("MDL")]))
                                                             ,A2($Material$Layout.link,
                                                             _U.list([$Html$Attributes.href("https://www.google.com/design/spec/material-design/introduction.html")]),
   ...
   var tabs = _U.list([{ctor: "_Tuple2"
                       ,_0: "Snackbar"
                       ,_1: F2(function (addr,model) {    return _U.list([A2($Demo$Snackbar.view,A2($Signal.forwardTo,addr,SnackbarAction),model.snackbar)]);})}
                      ,{ctor: "_Tuple2"
                       ,_0: "Textfields"
                       ,_1: F2(function (addr,model) {
                          return _U.list([A2($Demo$Textfields.view,A2($Signal.forwardTo,addr,TextfieldAction),model.textfields)]);
                       })}
                      ,{ctor: "_Tuple2"
                       ,_0: "Buttons"
                       ,_1: F2(function (addr,model) {    return _U.list([A2($Demo$Buttons.view,A2($Signal.forwardTo,addr,ButtonsAction),model.buttons)]);})}
                      ,{ctor: "_Tuple2",_0: "Grid",_1: F2(function (addr,model) {    return $Demo$Grid.view;})}]);
   var tabViews = $Array.fromList(A2($List.map,$Basics.snd,tabs));
   var tabTitles = A2($List.map,function (_p0) {    return $Html.text($Basics.fst(_p0));},tabs);
   var LayoutAction = function (a) {    return {ctor: "LayoutAction",_0: a};};
   var update = F2(function (action,model) {
      var _p1 = A2($Debug.log,"Action: ",action);
      switch (_p1.ctor)
      {case "LayoutAction": return A6($Material.lift,
           function (_) {
              return _.layout;
           },
           ...
           _p1._0,
           model);
         case "ButtonsAction": return A6($Material.lift,
           function (_) {
              return _.buttons;
           },
           ...
           _p1._0,
           model);
         case "TextfieldAction": return A5($Material.lift$,
           function (_) {
              return _.textfields;
           },
           ...
           _p1._0,
           model);
         default: return A6($Material.lift,
           function (_) {
              return _.snackbar;
           },
           F2(function (m,x) {    return _U.update(m,{snackbar: x});}),
   ...
   var view = F2(function (addr,model) {
      var top = A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "max-width",_1: "55rem"}
                                              ,{ctor: "_Tuple2",_0: "margin",_1: "auto"}
                                              ,{ctor: "_Tuple2",_0: "padding-left",_1: "5%"}
                                              ,{ctor: "_Tuple2",_0: "padding-right",_1: "5%"}]))]),
      A2(A2($Maybe.withDefault,
      F2(function (addr,model) {    return _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text("This can\'t happen.")]))]);}),
      A2($Array.get,model.layout.selectedTab,tabViews)),
      addr,
      model));
      return A3($Material.topWithScheme,
      $Material$Color.Teal,
      $Material$Color.Red,
      A3($Material$Layout.view,
      A2($Signal.forwardTo,addr,LayoutAction),
      model.layout,
      {header: $Maybe.Just(header),drawer: $Maybe.Just(drawer),tabs: $Maybe.Just(tabTitles),main: _U.list([stylesheet,top])}));
   });
   var inputs = _U.list([$Material$Layout.setupSizeChangeSignal(LayoutAction)]);
   var Model = F4(function (a,b,c,d) {    return {layout: a,buttons: b,textfields: c,snackbar: d};});
   var layoutModel = _U.update($Material$Layout.defaultLayoutModel,{state: $Material$Layout.initState($List.length(tabs))});
   var model = {layout: layoutModel,buttons: $Demo$Buttons.model,textfields: $Demo$Textfields.model,snackbar: $Demo$Snackbar.model};
